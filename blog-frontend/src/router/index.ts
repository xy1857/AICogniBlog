  ...
  routes: [
    // 博客前台
    {
      ...
      children: [
        ...
        { path: 'subscribe', name: 'Subscribe', component: () => import('@/views/blog/SubscribeView.vue'), meta: { requireAuth: true } },
        { path: 'follow', name: 'Follow', component: () => import('@/views/blog/FollowView.vue'), meta: { requireAuth: true } },
        { path: 'my-comments', name: 'MyComments', component: () => import('@/views/blog/MyCommentsView.vue'), meta: { requireAuth: true } },
        { path: 'my-likes', name: 'MyLikes', component: () => import('@/views/blog/MyLikesView.vue'), meta: { requireAuth: true } },
        { path: 'footprints', name: 'Footprints', component: () => import('@/views/blog/FootprintsView.vue'), meta: { requireAuth: true } },
        { path: 'comments/latest', name: 'LatestComments', component: () => import('@/views/blog/LatestCommentsView.vue') },
        { path: 'essays', name: 'Essays', component: () => import('@/views/blog/EssaysView.vue') },
